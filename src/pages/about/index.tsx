...
const About: React.FC = (): JSX.Element => {
  ...
  return (
    <>
      ...
      <section data-aos="zoom-in-right" data-aos-duration="3000" className="container">
        {/* about us */}
        ...
        <section data-aos="zoom-in-right" data-aos-duration="3000" className="container my-24">
